...
ScreenWidget::ScreenWidget(QWidget *parent) : QWidget(parent)
{
	...
	menu = new QMenu(this);
	menu->addAction("saveScreen", this, SLOT(saveScreen()));
	menu->addAction("saveFullScreen", this, SLOT(saveFullScreen()));
	menu->addAction("saveScreenOther", this, SLOT(saveScreenOther()));
	menu->addAction("saveFullOther", this, SLOT(saveFullOther()));
...
void ScreenWidget::paintEvent(QPaintEvent *)
{
	...
	painter.setPen(pen);
	painter.drawText(x + 2, y - 8, tr("screenshot：( %1 * %2 ) - ( %3 * %4 )  size of picture：( %5 * %6 )")
...
void ScreenWidget::saveScreenOther()
{
	...
	QString fileName = QFileDialog::getSaveFileName(this, "savePicture", name, "png Files (*.png)");
